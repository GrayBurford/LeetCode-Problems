...
// create helper functions to check if a character is upper, lowercase, and the same character
...
// if one is lower and the other upper and both are the same char, pop off stack
// if neither above (then both upper or both lower or not the same char), add current index char to stack
// return joined stack